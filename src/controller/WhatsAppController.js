...
export class WhatsAppController {
    ...
    // ativa o painel de contato com o contato referente
    ...
    initEvents() {
        ...
        this.el.btnAttach.on('click', e=>{
            ...
            this.el.btnSendPicture.on('click', e=> {
                ...
                // mudar a posicção da imagem/ virar imagen
